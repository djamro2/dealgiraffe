...
function parseResponse(items, singleItem) {
    ...
    for (var i = 0; i < items.length; i++) {
        ...
        if (items[i].price_amazon_new && items[i].price_amazon_new[0].price !== 0) {
            items[i].price = items[i].price_amazon_new[items[i].price_amazon_new.length - 1].price;
        } else if (items[i].price_third_new && items[i].price_third_new[0].price !== 0) {
            items[i].price = items[i].price_third_new[items[i].price_third_new.length - 1].price;
        } else if (items[i].price_third_used && items[i].price_third_used[0].price !== 0) {
